...
// 鱼眼标定：双目相机在线联合标定
bool runStereoFisheyeCalib(const std::string& imgDir = "../fisheye_img",
    const std::string& saveXml = "../stereo_calib.xml",
    int capId=0,
    int totalWidth=1280,
    int totalHeight=480);
...
// 鱼眼标定：双目相机离线联合标定
bool runStereoFisheyeCalib_FromImages(const std::string& imgDir = "../fisheye_img", const std::string& saveXml = "../fisheye_calib.xml");
